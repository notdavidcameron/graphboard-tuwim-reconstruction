...
json transparentVideoStateToJson(const graphboard::TransparentVideoHolderState& state) {
    ...
    for (const auto& entry : state.entries) {
        entries.push_back({
            ...
            {"persistentBacking", entry.stream.persistentBacking},
            {"streamTransparencyEnabled", entry.stream.transparencyEnabled},
            {"streamTransparentIndex", entry.stream.transparentIndex},
            {"drawTransparencyEnabled", entry.drawTransparencyEnabled},
            {"drawTransparentIndex", entry.drawTransparentIndex},
