...
$LogPath = Join-Path $LogDir "animation_full_pass_$Stamp.log"

Set-Location $Workspace
"GraphBoard full animation refresh log" | Tee-Object -FilePath $LogPath
...
foreach ($Start in 0,25,50,75,100,125,150,175,200) {
