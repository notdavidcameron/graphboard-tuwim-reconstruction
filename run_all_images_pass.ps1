...
$LogPath = Join-Path $LogDir "all_images_pass_$Stamp.log"

Set-Location $Workspace
"GraphBoard all-images extraction log" | Tee-Object -FilePath $LogPath
...
python .\extract_all_images.py $Source -o $Output --clean-collection 2>&1 |
    Tee-Object -FilePath $LogPath -Append
