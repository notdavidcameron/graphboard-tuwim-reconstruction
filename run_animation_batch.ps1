...
$LogPath = Join-Path $LogDir "animation_batch_$Stamp.log"

Set-Location $Workspace
"GraphBoard animation refresh log" | Tee-Object -FilePath $LogPath
...
python .\extract_animation_batch.py $Source -o $Output --batch-size 25 --start 0 --clean-first 2>&1 |
    Tee-Object -FilePath $LogPath -Append
